...
import appDevIcon from "../assets/images/icons/appdev.png";
import aiDevIcon from "../assets/images/icons/ai.png";
import webDevIcon from "../assets/images/icons/webdev.png";
    ...
    <>
      ...
      <section className="h-screen relative text-white">
        ...
        >
          ...
          <h1 className="heading text-stroke">Bluneuron AI</h1>
          <p className="sub-heading">
            Where Visionary Strategies Meet Intelligent Engineering
          </p>
        </div>
      </section>
      <div
      ...
      >
        <div className="bg-[#0A1828] rounded-lg p-5 shadow-lg border border-white/10">
          ...
          <p className="desc text-gray-300">
            Building intuitive, high-performance mobile applications for iOS and Android that drive user engagement.
          </p>
        </div>
        <div className="bg-[#0A1828] rounded-lg p-5 shadow-lg border border-white/10">
          <div className="flex items-center gap-3 mb-4">
            <img
              ...
              height="50"
              className="w-[3rem] object-contain"
              alt="Full-stack Website Development"
            />
            <p className="text-lg leading-tight font-medium">
          ...
          <p className="desc text-gray-300">
            Delivering robust, scalable, and visually stunning web solutions tailored to your business needs.
          </p>
        </div>
        <div className="bg-tertiary rounded-lg p-5 shadow-lg">
          <div className="flex gap-3 mb-4 items-center">
            <img
              loading="lazy"
              src={aiDevIcon}
          ...
          <p className="desc text-white">
            Empowering your business with intelligent, data-driven solutions and next-gen automation.
          </p>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 mt-7">
          ...
          >
            <div className="flex flex-col items-center lg:items-start gap-5 text-center lg:text-start">
              ...
              <p className="desc">
                At <b>Bluneuron AI</b>, we leverage the transformative
