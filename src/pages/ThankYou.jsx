        ...
        <div className="wrapper flex lg:flex-row flex-col gap-7 sm:gap-14 justify-between">
          <div className="">
            ...
            <p className="desc text-sm max-w-[22rem] mt-3">
              We design solutions that don't just solve today's problems but anticipate tomorrow's opportunities, keeping your business resilient and ahead of the curve.
            </p>
