        ...
        >
          ...
          <div className="py-[3rem] px-5 bg-primary/70 rounded-xl text-white relative z-10">
            ...
            <p className="font-light max-w-[50rem] text-center mx-auto mt-3">
              Embark on a transformative journey with Bluneuron AI. Where ethical innovation meets technical excellence, we build the future of your business on a foundation of trust and intelligence.
            </p>
